<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:35px;backgroundColor:rgba(74, 50, 22, 1);borderRadius:0;padding:0;boxShadow:0px 0px 0px 12px rgb(183,207,213) ;borderWidth:0;borderStyle:solid;borderColor:rgba(74, 50, 22, 1);">
