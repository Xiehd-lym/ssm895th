...
public class CaiwutongjiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,CaiwutongjiEntity caiwutongji, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,CaiwutongjiEntity caiwutongji, HttpServletRequest request){
        EntityWrapper<CaiwutongjiEntity> ew = new EntityWrapper<CaiwutongjiEntity>();
		PageUtils page = caiwutongjiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, caiwutongji), params), params));
        return R.ok().put("data", page);
    }
